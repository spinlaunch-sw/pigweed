...
// Pigweed's default mbedTLS configuration for MCU target.
//
// If you need to modify this config for your own project, consider providing
// your own config via the `@mbedtls//:mbedtls_config` label flag.
//
...
// Enable the platform abstraction layer to re-assign functions like snprintf()
#define MBEDTLS_PLATFORM_C
