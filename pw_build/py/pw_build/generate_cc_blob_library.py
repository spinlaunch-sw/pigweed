...
CHECKSUM_DECLARATION_TEMPLATE_CRC32 = Template(
    "\n${alignas}${section_attr}"
    "constexpr uint32_t ${symbol_name}_crc32 = ${checksum};\n"
)
...
def parse_args() -> dict:
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help='Optional checksum type to generate (e.g., "CRC32").',
    )
    ...
    for blob in blobs:
        ...
        if checksum_type == "CRC32":
            ...
            if blob.linker_section:
                ...
                section_attr = ""
            lines.append(
                CHECKSUM_DECLARATION_TEMPLATE_CRC32.substitute(
...
def main(
    ...
    out_header.write_text(header_from_blobs(blobs, namespace, checksum))
