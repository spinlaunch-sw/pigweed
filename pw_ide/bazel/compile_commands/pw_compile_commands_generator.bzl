...
def _pw_compile_commands_generator_impl(name, target_patterns = None, deps = None, platform = None, **kwargs):
...
pw_compile_commands_generator = macro(
    implementation = _pw_compile_commands_generator_impl,
    inherit_attrs = "common",
    attrs = {
        "deps": attr.label_list(
            configurable = False,
            doc = "Other pw_compile_commands_generator targets to merge into this database",
        ),
        "platform": attr.string(
            configurable = False,
            doc = "The platform to evaluate the provided target_patterns with",
        ),
        "target_patterns": attr.string_list(
            configurable = False,
            doc = " ".join([
                "Build target patterns to include in compile command databases",
                "generated by this rule. This may be individual targets (e.g.",
                "`//:foo`), the special `:all` target, or wildcard patterns",
                "(e.g. `//...`).",
            ]),
        ),
    },
